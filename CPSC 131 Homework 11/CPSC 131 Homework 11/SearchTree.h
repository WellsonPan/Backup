...
public:						// public functions
	...
	Position<E> lowestKey(const Position<E>& v);
	Position<E> highestKey(const Position<E>& v) const;
...
template <typename E>
Position<E> SearchTree<E>::lowestKey(const Position<E>& v)
{
	Position<E> temp = v;
	while (!v.isRoot())
	{
...
template <typename E>
Position<E> SearchTree::highestKey(const Position<E>& v) const
{
	Position<E> temp = v;
	while (!v.isRoot())
	{
